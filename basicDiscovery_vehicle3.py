...
data_csv = pd.read_csv (r'../../Lab4/DataFromClass/data2/vehicle3.csv')
data_csv.to_json (r'../../Lab4/DataFromClass/data2/vehicle3.json')
data_json = pd.read_json(r'../../Lab4/DataFromClass/data2/vehicle3.json')

data_josn = data_json['vehicle_CO2']
print(data_josn)
data_json = data_json.to_json()

#vehicle_CO2 = data_json['vehicle_CO2']
#print('vehicle_CO2 topic %s: %s\n' % (topic, vehicle_CO2))
...
while True:
    if args.mode == 'both' or args.mode == 'publish':
        ...
        myAWSIoTMQTTClient.publish(topic, data_json, 0)
