...
data_csv = pd.read_csv (r'../../Lab4/DataFromClass/data2/vehicle4.csv')
data_csv.to_json (r'../../Lab4/DataFromClass/data2/vehicle4.json')
data_json = pd.read_json(r'../../Lab4/DataFromClass/data2/vehicle4.json')
