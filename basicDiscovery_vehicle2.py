...
data_csv = pd.read_csv (r'../../Lab4/DataFromClass/data2/vehicle2.csv')
data_csv.to_json (r'../../Lab4/DataFromClass/data2/vehicle2.json')
data_json = pd.read_json(r'../../Lab4/DataFromClass/data2/vehicle2.json')
